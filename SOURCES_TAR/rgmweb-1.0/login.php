			...
			<div class="img col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					<div class="panel-heading">
						<img class="img-responsive center-block login-logo" src="'.$path_logo.'" alt="logo RGM">
					</div>
...
if(isset($_COOKIE['user_name'])){
	...
	<script type="text/javascript">
		...
		if (window!=top){
			...
			$("body").append('<div class="container"><div class="row">'
							...
							+		'<div class="login-panel panel panel-default">'
							+			'<div class="panel-heading">'
							+				'<img class="img-responsive center-block imb-logo login-logo" src="<?php echo $path_logo; ?>" alt="logo RGM">'
							+			'</div>'
							+			'<div class="panel-body">'
	...
	if( isset($_POST['login']) && isset($_POST['mdp']) ){
		...
		echo " <!-- There is post:".$login." -->";
		$mdp=$_POST['mdp'];
		echo " <!-- There is Pass:".$mdp." -->";
		$_POST[]=array();
