...
// encapsulated variables
    ...
    defaultOptions = {
        ...
        chart: {
            ...
            //spacingLeft: 10,
            //style: {
            //    fontFamily: '"Helvetica Neue",Helvetica, Verdana, Arial, Helvetica, sans-serif', // default font
            //    fontSize: '12px'
            //},
    ...
    SVGRenderer.prototype = {
        ...
        getStyle: function (style) {
            this.style = extend({
                fontFamily: '"Helvetica Neue",Helvetica, Arial, Helvetica, sans-serif', // default font
                fontSize: '12px'
            }, style);
            return this.style;
        },
