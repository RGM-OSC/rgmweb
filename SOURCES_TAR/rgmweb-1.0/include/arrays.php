...
$array_ged_packets = array (
	"contract"			=>	array("type"=>true,"key"=>true,"col"=>true),
	"site"				=>	array("type"=>true,"key"=>true,"col"=>true),
	"priority"			=>	array("type"=>true,"key"=>true,"col"=>true),
	"criticity"			=>	array("type"=>true,"key"=>true,"col"=>true),
	"warn_sla"			=>	array("type"=>true,"key"=>true,"col"=>true),
	"crit_sla"			=>	array("type"=>true,"key"=>true,"col"=>true),
	"extref_incident"	=>	array("type"=>true,"key"=>true,"col"=>true),
